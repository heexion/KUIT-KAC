...
fun OnboardingGrayScreen(
    ...
    Column(
        modifier = modifier
            ...
            .noRippleClickable {
                // 다음 화면으로 이동
                navController.navigate(OnboardingYellow.route)
            }
    ) {
        Image(
            painter = painterResource(id = R.drawable.bg_onboarding_gray),
...
@Composable
fun PreviewOnboardingGrayScreen() {
