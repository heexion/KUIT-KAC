...
fun OnboardingAiMealScreen(
    ...
    Column(
        modifier = modifier
            ...
            .noRippleClickable {
                // 다음 화면으로 이동
                navController.navigate(OnboardingMeal.route)
            }
    ) {
        Image(
            painter = painterResource(id = R.drawable.bg_onboarding_aimeal),
...
@Composable
fun PreviewOnboardingAiMealScreen() {
