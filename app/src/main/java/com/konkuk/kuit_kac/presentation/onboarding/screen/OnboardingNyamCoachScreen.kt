...
@Composable
fun OnboardingNyamCoachScreen(
    modifier: Modifier = Modifier,
    navController: NavHostController,
    bubbleText: String = "안녕? 나는 냠이야\n나는 앞으로 너의 식습관에\n영향을 받게 될 거야",
...
//        }
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "1. 오늘 정해진 칼로리보다 적게 먹으면\n   냠이가 뿌듯해 해!",
                    style = DungGeunMo15,
                    color = Color(0xFF000000)
                )
                Text(
                    text = "2. 너무 많이 먹으면 슬퍼할거야..",
                    style = DungGeunMo15,
                    color = Color(0xFF000000)
                )
            }
...
@Preview
@Composable
private fun OnboardingNyamCoachScreenPreview() {
