...
@Composable
fun OnboardingFloatingButtonScreen(
    ...
    Column(
        modifier = modifier
            ...
            .noRippleClickable {
                // 다음 화면으로 이동
                navController.navigate(OnboardingAiMeal.route)
            }
    ) {
        Image(
            painter = painterResource(id = R.drawable.bg_onboarding_floatingbutton3),
...
@Composable
fun PreviewOnboardingFloatingButtonScreen() {
